...
fn main() {
    ...
    let _precomputed: HashMap<&'static str, i8> = HashMap::from([
    ...
    let precomputed_2: HashMap<&'static str, i8> = HashMap::from([
    ...
    lines.iter().for_each(|line| {
        let line_score = precomputed_2.get(&line as &str).unwrap();
        total_score += i32::from(*line_score);
    });
